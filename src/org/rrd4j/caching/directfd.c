...
#define PAGESIZE org_rrd4j_caching_PageCache_PAGESIZE
 ...
 */
JNIEXPORT void JNICALL Java_org_rrd4j_caching_FilePage_prepare_1fd(JNIEnv *env, jclass _ignore, jstring filename, jobject fdobj, jboolean readOnly) {
    jfieldID field_fd;
 ...
 */
JNIEXPORT jint JNICALL Java_org_rrd4j_caching_PageCache_getAlignOffset(JNIEnv *env, jclass _ignore, jobject pageCacheBuffer) {
    void * pointer;
